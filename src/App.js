  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/products/men-tees/:id" element={<Product  cartToggle={cartToggle} setCartToggle={setCartToggle}  />} />
        ...
        <Route path="/products/single-product" element={<Product  cartToggle={cartToggle} setCartToggle={setCartToggle}  />} />
